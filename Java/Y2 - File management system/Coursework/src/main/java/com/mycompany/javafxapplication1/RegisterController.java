...
public class RegisterController {
    ...
    private void registerBtnHandler(ActionEvent event) {
        ...
        try {
            ...
            DB myObj = new DB();
            if (userTextField.getText().equals("") || userTextField.getText().equals(" ")) {
                dialogue("Username cannot be blank", "Please enter a user name");
                return;
            }
            if (passPasswordField.getText().equals("")) {
                dialogue("password cannot be blank", "Please enter a password");
                return;
            }
            if (myObj.UserInDB(userTextField.getText())) {
                dialogue("Username is taken", "Please enter a different user name");
                return;
            }
